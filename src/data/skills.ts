...
export const skills: SkillGroup[] = [
  ...
  { label: '3D / graphics', items: 'Three.js, Threlte, WebGL shaders (GLSL)' },
  { label: 'Databases', items: 'PostgreSQL, MongoDB' },
  { label: 'ORM / data', items: 'Prisma, Mongoose, REST APIs, Zod' },
  { label: 'Auth & security', items: 'Passport.js, sessions (__Host- cookies), JWT, argon2 / bcrypt, Helmet, rate limiting, Cloudflare Turnstile' },
  { label: 'Deployment', items: 'Docker & Compose, nginx (reverse proxy), GitHub Actions, GHCR, Docker Buildx (multi-arch), Tailscale, SSH, automated backups (cron), Railway, Netlify' },
  ...
  { label: 'Testing', items: 'Unit, integration & E2E testing: Vitest, Jest, React Testing Library, Playwright, Supertest, accessibility audits (Lighthouse 100)' },
